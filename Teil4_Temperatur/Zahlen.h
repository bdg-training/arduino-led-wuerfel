...
void zahl2k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {

  ledOffsetOben(LED_V_2x1, offset, color, pixels);
  ledOffsetOben(LED_V_5x1, offset, color, pixels);
  
  ledOffsetOben(LED_V_1x2, offset, color, pixels);
  ledOffsetOben(LED_V_4x2, offset, color, pixels);
  ledOffsetOben(LED_V_5x2, offset, color, pixels);
...
void zahl3k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {

  ledOffsetOben(LED_V_1x1, offset, color, pixels);
  ledOffsetOben(LED_V_3x1, offset, color, pixels);
  ledOffsetOben(LED_V_5x1, offset, color, pixels);
  
  ledOffsetOben(LED_V_1x2, offset, color, pixels);
  ledOffsetOben(LED_V_3x2, offset, color, pixels);
  ledOffsetOben(LED_V_5x2, offset, color, pixels);
...
void zahl4k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
...
void zahl5k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
  ...
  ledOffsetOben(LED_V_1x4, offset, color, pixels);
  ledOffsetOben(LED_V_4x4, offset, color, pixels);
}

void zahl6k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
...
void zahl7k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
...
void zahl8k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
...
void zahl9k(uint32_t color, int offset, Adafruit_NeoPixel & pixels) {
